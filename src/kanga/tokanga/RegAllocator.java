...
//					prevnode.addNode(new temp2reg(temp.temp_num,false,stackpos++));
			...
			else
			{
				...
				if(i == usedRegNum)
				{
					usedReg[usedRegNum++]=regNum;//usedRegsArray
				}
				active.add(temp);
				prevnode.regs.put(temp.temp_num,new temp2reg(temp.temp_num,true, regNum));
			}
